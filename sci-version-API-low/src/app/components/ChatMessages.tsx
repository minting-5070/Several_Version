...
const APP_VERSION = 'sci-version-api-low';
...
function extractAnswerOnly(content: string) {
  // Keep only the Answer section before separators or next headings
  const startMarkers = [
    '## 🎯 **Answer**',
    '## 🎯 Answer',
    '## Answer',
  ...
  return (
    <div className="space-y-4">
      {messages.map((msg, index) => {
        ...
        const answerOnly = msg.role === 'assistant' ? extractAnswerOnly(mainContent) : mainContent;
                ...
                <div className={`prose max-w-none ${
                  ...
                  {msg.role === 'assistant' && (
                    <div className="mt-3 text-xs text-blue-400">
                      👉 See detailed 10-paper cards in the right-hand table.
                    </div>
                  )}
                  {references && (
                    <div className="mt-4">
